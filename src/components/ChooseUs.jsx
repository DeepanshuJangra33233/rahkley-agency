...
const ChooseUs = () => {
  return (
    <div className="min-h-screen flex items-center container mx-auto xl:max-w-[1140px] px-3">
      <div className="flex items-center w-full justify-between flex-col lg:flex-row">
        <div className="w-full lg:w-1/2 text-center lg:text-start">
          ...
          <p className="max-w-[440px] text-neutralWhite text-base font-normal opacity-80 font-plus-jakarta mb-5 sm:mb-[35px] mx-auto lg:ms-0">
            We reveal what interests customers in your brand and bring it under
            the spotlight so you can outperform your competitors. Thinking
            outside the box to develop revenue-generating campaigns for your
            business. In other words, we are the creative partner you’ve always
            dreamed about!
          </p>
          <button
        ...
        <div className="w-full relative mt-9 lg:mt-0 lg:w-1/2 xl:w-[40%] bg-reviewCard bg-cover bg-no-repeat bg-center p-5 xsm:ps-[30px] xsm:pe-10 xsm:pt-[67px] xsm:pb-[22px] border border-[#666767] bg-[rgba(255,_253,_255,_0.12)] rounded-[20px] shadow-[0px_4px_37px_0px_rgba(255,_255,_255,_0.15)_inset]">
          ...
          <p className="opacity-80 font-plus-jakarta text-base italic text-neutralWhite leading-[25px] font-normal text-center lg:text-start">
            ...
            fusce pharetra est purus faucibus tellus justo vehicula. Risus odio
            diam interdum ullamcorper aliquam mi nulla est posuere massa
            estibulum in tincidunt ullamcorper condimentum.{" "}
