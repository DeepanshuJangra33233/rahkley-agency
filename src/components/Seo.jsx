    ...
    <div className="min-h-screen flex items-center container mx-auto xl:max-w-[1140px] px-3">
      <div className="w-full relative">
        ...
        {seoTitleList.map((value, index) => (
          <div
            key={index}
            className="max-w-[650px] lg:max-w-[850px] xl:max-w-[940px] w-full seo_card relative bg-white bg-opacity-[0.1] hover:bg-opacity-0 p-4 sm:px-[30px] sm:py-[25px] lg:py-[43px] lg:ps-[60px] -mt-1 sm:-mt-2"
          >
